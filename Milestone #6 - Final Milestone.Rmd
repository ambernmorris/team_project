...
caption= "Counts of Participants by Race, Smoking Status, and Income from 2011 California 
Smokers Cohort") %>% kable_styling(latex_options = "striped")
```
