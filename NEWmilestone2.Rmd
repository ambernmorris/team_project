...
new_race_data <- rename(clean_race_data, heart_disease=heartdis, 
              ...
              filipino=race05, korean=race06, asian_or_pacific_islander=race07,   american_indian_or_alaskan_native=race08, mexican=race09, 
...
updated_race_data <- select(new_race_data, c("heart_disease", "income", "white", 
                      "black", "japanese", "chinese", "filipino", "korean", "asian_or_pacific_islander", "american_indian_or_alaskan_native", "mexican", 
