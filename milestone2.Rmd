...
#ask if we need to rename everything or just the ones we use
...
#post a question on ed discussion to see if we need to pick 5 from each data set or 5 total
#actually pick the elements (columns) that will help answer the project question
