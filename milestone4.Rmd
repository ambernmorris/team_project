...
#identified 9 rows where unit is wrong, tried if_else, case_when, and repalce() and none of those worked. so pack years calculation is still off by 9 observations.
